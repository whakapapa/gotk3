...
//
//export goMarshal
func goMarshal(closure *C.GClosure, retValue *C.GValue, nParams C.guint, params *C.GValue, invocationHint C.gpointer, marshalData *C.GValue) {
...
func (v *Object) Set(name string, value interface{}) error {
	...
	default:
		switch {
		case pv, ok := value.(unsafe.Pointer); ok:
			p = pv
		default:
...
func SignalNew(s string) (*Signal, error) {
	...
	return &Signal{name: s, signalId: signalId, }, nil
}
